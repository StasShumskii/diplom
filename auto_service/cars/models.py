...
class UserCar(models.Model):
    ...
    engine_type = models.CharField(max_length=20, choices=EngineType.choices, blank=True, null=True, verbose_name=_('Тип двигуна'))
    engine_volume = models.DecimalField(max_digits=3, decimal_places=1, blank=True, null=True, verbose_name=_('Об\'єм двигуна (л)'))
    fuel_type = models.CharField(max_length=20, choices=FuelType.choices, blank=True, null=True, verbose_name=_('Тип палива'))
    technical_condition = models.CharField(max_length=20, choices=TechnicalCondition.choices, default=TechnicalCondition.GOOD, verbose_name=_('Технічний стан'))
