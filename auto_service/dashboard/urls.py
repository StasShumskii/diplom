...
urlpatterns = [
    ...
    # Legacy URLs
    path('dashboard/booking-status/<int:booking_id>/', views.update_booking_status, name='update_booking_status_legacy'),
    path('dashboard/booking-assign/<int:booking_id>/', views.assign_mechanic, name='assign_mechanic_legacy'),
    path('dashboard/bookings/<int:booking_id>/status/', views.update_booking_status, name='update_booking_status_old'),
    path('dashboard/bookings/<int:booking_id>/assign/', views.assign_mechanic, name='assign_mechanic_old'),
